 ...
 */
class DependencyInjectionContainer_6c433600e68abefd43f778a8605cce24586daf12 extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'SFC\\Staticfilecache\\Cache\\IdentifierBuilder' => 'getIdentifierBuilderService',
            'SFC\\Staticfilecache\\Cache\\Listener\\ForceStaticCacheListener' => 'getForceStaticCacheListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\NoBackendUserCookieListener' => 'getNoBackendUserCookieListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\NoBackendUserListener' => 'getNoBackendUserListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\PageCacheableListener' => 'getPageCacheableListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\SolrIndexingProcessListener' => 'getSolrIndexingProcessListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\StaticCacheableListener' => 'getStaticCacheableListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\ValidRequestMethodListener' => 'getValidRequestMethodListenerService',
            'SFC\\Staticfilecache\\Cache\\Listener\\ValidUriListener' => 'getValidUriListenerService',
            'SFC\\Staticfilecache\\Cache\\Rule\\Enable' => 'getEnableService',
            'SFC\\Staticfilecache\\Cache\\Rule\\LoginDeniedConfiguration' => 'getLoginDeniedConfigurationService',
            'SFC\\Staticfilecache\\Cache\\Rule\\NoFakeFrontend' => 'getNoFakeFrontendService',
            'SFC\\Staticfilecache\\Cache\\Rule\\NoIntScripts' => 'getNoIntScriptsService',
            'SFC\\Staticfilecache\\Cache\\Rule\\NoLongPathSegment' => 'getNoLongPathSegmentService',
            'SFC\\Staticfilecache\\Cache\\Rule\\NoNoCache' => 'getNoNoCacheService',
            'SFC\\Staticfilecache\\Cache\\Rule\\NoUserOrGroupSet' => 'getNoUserOrGroupSetService',
            'SFC\\Staticfilecache\\Cache\\Rule\\NoWorkspacePreview' => 'getNoWorkspacePreviewService',
            'SFC\\Staticfilecache\\Cache\\Rule\\SiteCacheable' => 'getSiteCacheableService',
            'SFC\\Staticfilecache\\Cache\\Rule\\ValidDoktype' => 'getValidDoktypeService',
            'SFC\\Staticfilecache\\Cache\\Rule\\ValidPageInformation' => 'getValidPageInformationService',
            'SFC\\Staticfilecache\\Command\\BoostQueueCommand' => 'getBoostQueueCommandService',
            'SFC\\Staticfilecache\\Configuration' => 'getConfigurationService',
            'SFC\\Staticfilecache\\Controller\\BackendController' => 'getBackendControllerService',
            'SFC\\Staticfilecache\\Domain\\Repository\\CacheRepository' => 'getCacheRepositoryService',
            'SFC\\Staticfilecache\\Domain\\Repository\\PageRepository' => 'getPageRepositoryService',
            'SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository' => 'getQueueRepositoryService',
            'SFC\\Staticfilecache\\EventListener\\AfterPackageDeactivationListener' => 'getAfterPackageDeactivationListenerService',
            'SFC\\Staticfilecache\\Generator\\BrotliGenerator' => 'getBrotliGeneratorService',
            'SFC\\Staticfilecache\\Generator\\ConfigGenerator' => 'getConfigGeneratorService',
            'SFC\\Staticfilecache\\Generator\\GzipGenerator' => 'getGzipGeneratorService',
            'SFC\\Staticfilecache\\Generator\\HtaccessGenerator' => 'getHtaccessGeneratorService',
            'SFC\\Staticfilecache\\Generator\\ManifestGenerator' => 'getManifestGeneratorService',
            'SFC\\Staticfilecache\\Generator\\PlainGenerator' => 'getPlainGeneratorService',
            'SFC\\Staticfilecache\\Hook\\AbstractHook' => 'getAbstractHookService',
            'SFC\\Staticfilecache\\Hook\\DatamapHook' => 'getDatamapHookService',
            'SFC\\Staticfilecache\\Hook\\LogoffFrontendUser' => 'getLogoffFrontendUserService',
            'SFC\\Staticfilecache\\Middleware\\FallbackMiddleware' => 'getFallbackMiddlewareService',
            'SFC\\Staticfilecache\\Middleware\\FrontendUserMiddleware' => 'getFrontendUserMiddlewareService',
            'SFC\\Staticfilecache\\Middleware\\GenerateMiddleware' => 'getGenerateMiddlewareService',
            'SFC\\Staticfilecache\\Middleware\\ManifestMiddleware' => 'getManifestMiddlewareService',
            'SFC\\Staticfilecache\\Middleware\\PrepareMiddleware' => 'getPrepareMiddlewareService',
            'SFC\\Staticfilecache\\Service\\AbstractService' => 'getAbstractServiceService',
            'SFC\\Staticfilecache\\Service\\CacheService' => 'getCacheServiceService',
            'SFC\\Staticfilecache\\Service\\ClientService' => 'getClientServiceService',
            'SFC\\Staticfilecache\\Service\\ConfigurationService' => 'getConfigurationServiceService',
            'SFC\\Staticfilecache\\Service\\CookieService' => 'getCookieServiceService',
            'SFC\\Staticfilecache\\Service\\DateTimeService' => 'getDateTimeServiceService',
            'SFC\\Staticfilecache\\Service\\GeneratorService' => 'getGeneratorServiceService',
            'SFC\\Staticfilecache\\Service\\HtaccessConfigurationService' => 'getHtaccessConfigurationServiceService',
            'SFC\\Staticfilecache\\Service\\HttpPushService' => 'getHttpPushServiceService',
            'SFC\\Staticfilecache\\Service\\HttpPush\\FontHttpPush' => 'getFontHttpPushService',
            'SFC\\Staticfilecache\\Service\\HttpPush\\ImageHttpPush' => 'getImageHttpPushService',
            'SFC\\Staticfilecache\\Service\\HttpPush\\ScriptHttpPush' => 'getScriptHttpPushService',
            'SFC\\Staticfilecache\\Service\\HttpPush\\StyleHttpPush' => 'getStyleHttpPushService',
            'SFC\\Staticfilecache\\Service\\ObjectFactoryService' => 'getObjectFactoryServiceService',
            'SFC\\Staticfilecache\\Service\\QueueService' => 'getQueueServiceService',
            'SFC\\Staticfilecache\\Service\\RemoveService' => 'getRemoveServiceService',
            'SFC\\Staticfilecache\\Service\\TypoScriptFrontendService' => 'getTypoScriptFrontendServiceService',
            'SFC\\Staticfilecache\\ViewHelpers\\Be\\Menus\\ActionMenuViewHelper' => 'getActionMenuViewHelperService',
            ...
            'TYPO3\\CMS\\Adminpanel\\Service\\ConfigurationService' => 'getConfigurationService2Service',
            ...
            'TYPO3\\CMS\\Extbase\\Service\\CacheService' => 'getCacheService2Service',
            ...
            'TYPO3\\CMS\\Fluid\\ViewHelpers\\Be\\Menus\\ActionMenuViewHelper' => 'getActionMenuViewHelper2Service',
            ...
            'TYPO3\\CMS\\Form\\Domain\\Configuration\\ConfigurationService' => 'getConfigurationService3Service',
            ...
            'backend.routes_decorated_40' => 'getBackend_RoutesDecorated40Service',
            ...
            'icons_decorated_40' => 'getIconsDecorated40Service',
            'middlewares_decorated_39' => 'getMiddlewaresDecorated39Service',
        ...
        $this->aliases = [
            ...
            'backend.routes' => 'backend.routes_decorated_40',
            'backend.routes_decorated_1' => 'backend.routes_decorated_40',
            'backend.routes_decorated_10' => 'backend.routes_decorated_40',
            'backend.routes_decorated_11' => 'backend.routes_decorated_40',
            'backend.routes_decorated_12' => 'backend.routes_decorated_40',
            'backend.routes_decorated_13' => 'backend.routes_decorated_40',
            'backend.routes_decorated_14' => 'backend.routes_decorated_40',
            'backend.routes_decorated_15' => 'backend.routes_decorated_40',
            'backend.routes_decorated_16' => 'backend.routes_decorated_40',
            'backend.routes_decorated_17' => 'backend.routes_decorated_40',
            'backend.routes_decorated_18' => 'backend.routes_decorated_40',
            'backend.routes_decorated_19' => 'backend.routes_decorated_40',
            'backend.routes_decorated_2' => 'backend.routes_decorated_40',
            'backend.routes_decorated_20' => 'backend.routes_decorated_40',
            'backend.routes_decorated_21' => 'backend.routes_decorated_40',
            'backend.routes_decorated_22' => 'backend.routes_decorated_40',
            'backend.routes_decorated_23' => 'backend.routes_decorated_40',
            'backend.routes_decorated_24' => 'backend.routes_decorated_40',
            'backend.routes_decorated_25' => 'backend.routes_decorated_40',
            'backend.routes_decorated_26' => 'backend.routes_decorated_40',
            'backend.routes_decorated_27' => 'backend.routes_decorated_40',
            'backend.routes_decorated_28' => 'backend.routes_decorated_40',
            'backend.routes_decorated_29' => 'backend.routes_decorated_40',
            'backend.routes_decorated_3' => 'backend.routes_decorated_40',
            'backend.routes_decorated_30' => 'backend.routes_decorated_40',
            'backend.routes_decorated_31' => 'backend.routes_decorated_40',
            'backend.routes_decorated_32' => 'backend.routes_decorated_40',
            'backend.routes_decorated_33' => 'backend.routes_decorated_40',
            'backend.routes_decorated_34' => 'backend.routes_decorated_40',
            'backend.routes_decorated_35' => 'backend.routes_decorated_40',
            'backend.routes_decorated_36' => 'backend.routes_decorated_40',
            'backend.routes_decorated_37' => 'backend.routes_decorated_40',
            'backend.routes_decorated_38' => 'backend.routes_decorated_40',
            'backend.routes_decorated_39' => 'backend.routes_decorated_40',
            'backend.routes_decorated_4' => 'backend.routes_decorated_40',
            'backend.routes_decorated_5' => 'backend.routes_decorated_40',
            'backend.routes_decorated_6' => 'backend.routes_decorated_40',
            'backend.routes_decorated_7' => 'backend.routes_decorated_40',
            'backend.routes_decorated_8' => 'backend.routes_decorated_40',
            'backend.routes_decorated_9' => 'backend.routes_decorated_40',
            ...
            'icons' => 'icons_decorated_40',
            'icons_decorated_1' => 'icons_decorated_40',
            'icons_decorated_10' => 'icons_decorated_40',
            'icons_decorated_11' => 'icons_decorated_40',
            'icons_decorated_12' => 'icons_decorated_40',
            'icons_decorated_13' => 'icons_decorated_40',
            'icons_decorated_14' => 'icons_decorated_40',
            'icons_decorated_15' => 'icons_decorated_40',
            'icons_decorated_16' => 'icons_decorated_40',
            'icons_decorated_17' => 'icons_decorated_40',
            'icons_decorated_18' => 'icons_decorated_40',
            'icons_decorated_19' => 'icons_decorated_40',
            'icons_decorated_2' => 'icons_decorated_40',
            'icons_decorated_20' => 'icons_decorated_40',
            'icons_decorated_21' => 'icons_decorated_40',
            'icons_decorated_22' => 'icons_decorated_40',
            'icons_decorated_23' => 'icons_decorated_40',
            'icons_decorated_24' => 'icons_decorated_40',
            'icons_decorated_25' => 'icons_decorated_40',
            'icons_decorated_26' => 'icons_decorated_40',
            'icons_decorated_27' => 'icons_decorated_40',
            'icons_decorated_28' => 'icons_decorated_40',
            'icons_decorated_29' => 'icons_decorated_40',
            'icons_decorated_3' => 'icons_decorated_40',
            'icons_decorated_30' => 'icons_decorated_40',
            'icons_decorated_31' => 'icons_decorated_40',
            'icons_decorated_32' => 'icons_decorated_40',
            'icons_decorated_33' => 'icons_decorated_40',
            'icons_decorated_34' => 'icons_decorated_40',
            'icons_decorated_35' => 'icons_decorated_40',
            'icons_decorated_36' => 'icons_decorated_40',
            'icons_decorated_37' => 'icons_decorated_40',
            'icons_decorated_38' => 'icons_decorated_40',
            'icons_decorated_39' => 'icons_decorated_40',
            'icons_decorated_4' => 'icons_decorated_40',
            'icons_decorated_5' => 'icons_decorated_40',
            'icons_decorated_6' => 'icons_decorated_40',
            'icons_decorated_7' => 'icons_decorated_40',
            'icons_decorated_8' => 'icons_decorated_40',
            'icons_decorated_9' => 'icons_decorated_40',
            'middlewares' => 'middlewares_decorated_39',
            'middlewares_decorated_1' => 'middlewares_decorated_39',
            'middlewares_decorated_10' => 'middlewares_decorated_39',
            'middlewares_decorated_11' => 'middlewares_decorated_39',
            'middlewares_decorated_12' => 'middlewares_decorated_39',
            'middlewares_decorated_13' => 'middlewares_decorated_39',
            'middlewares_decorated_14' => 'middlewares_decorated_39',
            'middlewares_decorated_15' => 'middlewares_decorated_39',
            'middlewares_decorated_16' => 'middlewares_decorated_39',
            'middlewares_decorated_17' => 'middlewares_decorated_39',
            'middlewares_decorated_18' => 'middlewares_decorated_39',
            'middlewares_decorated_19' => 'middlewares_decorated_39',
            'middlewares_decorated_2' => 'middlewares_decorated_39',
            'middlewares_decorated_20' => 'middlewares_decorated_39',
            'middlewares_decorated_21' => 'middlewares_decorated_39',
            'middlewares_decorated_22' => 'middlewares_decorated_39',
            'middlewares_decorated_23' => 'middlewares_decorated_39',
            'middlewares_decorated_24' => 'middlewares_decorated_39',
            'middlewares_decorated_25' => 'middlewares_decorated_39',
            'middlewares_decorated_26' => 'middlewares_decorated_39',
            'middlewares_decorated_27' => 'middlewares_decorated_39',
            'middlewares_decorated_28' => 'middlewares_decorated_39',
            'middlewares_decorated_29' => 'middlewares_decorated_39',
            'middlewares_decorated_3' => 'middlewares_decorated_39',
            'middlewares_decorated_30' => 'middlewares_decorated_39',
            'middlewares_decorated_31' => 'middlewares_decorated_39',
            'middlewares_decorated_32' => 'middlewares_decorated_39',
            'middlewares_decorated_33' => 'middlewares_decorated_39',
            'middlewares_decorated_34' => 'middlewares_decorated_39',
            'middlewares_decorated_35' => 'middlewares_decorated_39',
            'middlewares_decorated_36' => 'middlewares_decorated_39',
            'middlewares_decorated_37' => 'middlewares_decorated_39',
            'middlewares_decorated_38' => 'middlewares_decorated_39',
            'middlewares_decorated_4' => 'middlewares_decorated_39',
            'middlewares_decorated_5' => 'middlewares_decorated_39',
            'middlewares_decorated_6' => 'middlewares_decorated_39',
            'middlewares_decorated_7' => 'middlewares_decorated_39',
            'middlewares_decorated_8' => 'middlewares_decorated_39',
            'middlewares_decorated_9' => 'middlewares_decorated_39',
        ];
    }
    ...
    {
        return [
            '.abstract.instanceof.B13\\Container\\View\\ContainerLayoutView' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\IdentifierBuilder' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\RemoteFileBackend' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\Enable' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\LoginDeniedConfiguration' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\NoFakeFrontend' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\NoIntScripts' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\NoLongPathSegment' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\NoNoCache' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\NoUserOrGroupSet' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\NoWorkspacePreview' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\SiteCacheable' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\ValidDoktype' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\Rule\\ValidPageInformation' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Cache\\StaticFileBackend' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Configuration' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Controller\\BackendController' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Domain\\Repository\\CacheRepository' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Domain\\Repository\\PageRepository' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Generator\\BrotliGenerator' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Generator\\ConfigGenerator' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Generator\\GzipGenerator' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Generator\\HtaccessGenerator' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Generator\\ManifestGenerator' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Generator\\PlainGenerator' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Hook\\AbstractHook' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Hook\\DatamapHook' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Hook\\LogoffFrontendUser' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Middleware\\FallbackMiddleware' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Middleware\\FrontendUserMiddleware' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Middleware\\GenerateMiddleware' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Middleware\\ManifestMiddleware' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Middleware\\PrepareMiddleware' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\AbstractService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\CacheService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\ClientService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\ConfigurationService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\CookieService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\DateTimeService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\GeneratorService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\HtaccessConfigurationService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\HttpPushService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\HttpPush\\FontHttpPush' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\HttpPush\\ImageHttpPush' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\HttpPush\\ScriptHttpPush' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\HttpPush\\StyleHttpPush' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\ObjectFactoryService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\QueueService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\RemoveService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\Service\\TypoScriptFrontendService' => true,
            '.abstract.instanceof.SFC\\Staticfilecache\\ViewHelpers\\Be\\Menus\\ActionMenuViewHelper' => true,
            ...
            '.instanceof.Psr\\Http\\Server\\MiddlewareInterface.0.SFC\\Staticfilecache\\Middleware\\FallbackMiddleware' => true,
            '.instanceof.Psr\\Http\\Server\\MiddlewareInterface.0.SFC\\Staticfilecache\\Middleware\\FrontendUserMiddleware' => true,
            '.instanceof.Psr\\Http\\Server\\MiddlewareInterface.0.SFC\\Staticfilecache\\Middleware\\GenerateMiddleware' => true,
            '.instanceof.Psr\\Http\\Server\\MiddlewareInterface.0.SFC\\Staticfilecache\\Middleware\\ManifestMiddleware' => true,
            '.instanceof.Psr\\Http\\Server\\MiddlewareInterface.0.SFC\\Staticfilecache\\Middleware\\PrepareMiddleware' => true,
            ...
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.B13\\Container\\View\\ContainerLayoutView' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\IdentifierBuilder' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\RemoteFileBackend' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\Enable' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\LoginDeniedConfiguration' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoFakeFrontend' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoIntScripts' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoLongPathSegment' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoNoCache' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoUserOrGroupSet' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoWorkspacePreview' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\SiteCacheable' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\ValidDoktype' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\ValidPageInformation' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Cache\\StaticFileBackend' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Configuration' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Domain\\Repository\\CacheRepository' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Domain\\Repository\\PageRepository' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Generator\\BrotliGenerator' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Generator\\ConfigGenerator' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Generator\\GzipGenerator' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Generator\\HtaccessGenerator' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Generator\\ManifestGenerator' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Generator\\PlainGenerator' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Hook\\AbstractHook' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Hook\\DatamapHook' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Hook\\LogoffFrontendUser' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\AbstractService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\CacheService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\ClientService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\ConfigurationService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\CookieService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\DateTimeService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\GeneratorService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\HtaccessConfigurationService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\HttpPushService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\FontHttpPush' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\ImageHttpPush' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\ScriptHttpPush' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\StyleHttpPush' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\ObjectFactoryService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\QueueService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\RemoveService' => true,
            '.instanceof.Psr\\Log\\LoggerAwareInterface.0.SFC\\Staticfilecache\\Service\\TypoScriptFrontendService' => true,
            ...
            '.instanceof.TYPO3Fluid\\Fluid\\Core\\ViewHelper\\ViewHelperInterface.0.SFC\\Staticfilecache\\ViewHelpers\\Be\\Menus\\ActionMenuViewHelper' => true,
            ...
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\IdentifierBuilder' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\Enable' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\LoginDeniedConfiguration' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoFakeFrontend' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoIntScripts' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoLongPathSegment' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoNoCache' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoUserOrGroupSet' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\NoWorkspacePreview' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\SiteCacheable' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\ValidDoktype' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Cache\\Rule\\ValidPageInformation' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Configuration' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Domain\\Repository\\CacheRepository' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Domain\\Repository\\PageRepository' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Generator\\BrotliGenerator' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Generator\\ConfigGenerator' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Generator\\GzipGenerator' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Generator\\HtaccessGenerator' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Generator\\ManifestGenerator' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Generator\\PlainGenerator' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Hook\\AbstractHook' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Hook\\DatamapHook' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Hook\\LogoffFrontendUser' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\AbstractService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\CacheService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\ClientService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\ConfigurationService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\CookieService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\DateTimeService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\GeneratorService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\HtaccessConfigurationService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\HttpPushService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\FontHttpPush' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\ImageHttpPush' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\ScriptHttpPush' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\HttpPush\\StyleHttpPush' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\ObjectFactoryService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\QueueService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\RemoveService' => true,
            '.instanceof.TYPO3\\CMS\\Core\\SingletonInterface.0.SFC\\Staticfilecache\\Service\\TypoScriptFrontendService' => true,
            ...
            '.instanceof.TYPO3\\CMS\\Extbase\\Mvc\\Controller\\ActionController.0.SFC\\Staticfilecache\\Controller\\BackendController' => true,
            ...
            '.instanceof.TYPO3\\CMS\\Extbase\\Mvc\\Controller\\ControllerInterface.0.SFC\\Staticfilecache\\Controller\\BackendController' => true,
            ...
            'SFC\\Staticfilecache\\Cache\\RemoteFileBackend' => true,
            'SFC\\Staticfilecache\\Cache\\StaticFileBackend' => true,
            'SFC\\Staticfilecache\\Cache\\UriFrontend' => true,
            'SFC\\Staticfilecache\\Command\\FlushCacheCommand' => true,
            'SFC\\Staticfilecache\\Event\\BuildClientEvent' => true,
            'SFC\\Staticfilecache\\Event\\CacheRuleEvent' => true,
            'SFC\\Staticfilecache\\Event\\CacheRuleFallbackEvent' => true,
            'SFC\\Staticfilecache\\Event\\ForceStaticFileCacheEvent' => true,
            'SFC\\Staticfilecache\\Event\\PreGenerateEvent' => true,
            'SFC\\Staticfilecache\\Exception' => true,
            'SFC\\Staticfilecache\\Service\\EnvironmentService' => true,
     ...
     */
    protected function getDeleteChildrenWithWrongPidCommandService()
    {
        $this->services['B13\\Container\\Command\\DeleteChildrenWithWrongPidCommand'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\Command\DeleteChildrenWithWrongPidCommand::class);
     ...
     */
    protected function getFixContainerParentForConnectedModeCommandService()
    {
        $this->services['B13\\Container\\Command\\FixContainerParentForConnectedModeCommand'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\Command\FixContainerParentForConnectedModeCommand::class);

        $instance->setName('container:fixContainerParentForConnectedModeCommand');
     ...
     */
    protected function getFixLanguageModeCommandService()
    {
        $this->services['B13\\Container\\Command\\FixLanguageModeCommand'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\Command\FixLanguageModeCommand::class);

        $instance->setName('container:fixLanguageModeCommand');
     ...
     */
    protected function getIntegrityCommandService()
    {
        $this->services['B13\\Container\\Command\\IntegrityCommand'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\Command\IntegrityCommand::class);
     ...
     */
    protected function getBootCompletedService()
    {
        return $this->services['B13\\Container\\Listener\\BootCompleted'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\Listener\BootCompleted::class);
    }
     ...
     */
    protected function getPageTsConfigService()
    {
        return $this->services['B13\\Container\\Listener\\PageTsConfig'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\Listener\PageTsConfig::class);
    }
     ...
     */
    protected function getContainerLayoutViewService()
    {
        $this->factories['B13\\Container\\View\\ContainerLayoutView'] = function () {
            $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\B13\Container\View\ContainerLayoutView::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));

            $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('B13\\Container\\View\\ContainerLayoutView'));

            return $instance;
        };

        return $this->factories['B13\\Container\\View\\ContainerLayoutView']();
    }
    ...
    /**
     * Gets the public 'SFC\Staticfilecache\Cache\IdentifierBuilder' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\IdentifierBuilder
     */
    protected function getIdentifierBuilderService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\IdentifierBuilder'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\IdentifierBuilder::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\IdentifierBuilder'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\ForceStaticCacheListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\ForceStaticCacheListener
     */
    protected function getForceStaticCacheListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\ForceStaticCacheListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\ForceStaticCacheListener::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\NoBackendUserCookieListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\NoBackendUserCookieListener
     */
    protected function getNoBackendUserCookieListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\NoBackendUserCookieListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\NoBackendUserCookieListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\NoBackendUserListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\NoBackendUserListener
     */
    protected function getNoBackendUserListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\NoBackendUserListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\NoBackendUserListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\PageCacheableListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\PageCacheableListener
     */
    protected function getPageCacheableListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\PageCacheableListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\PageCacheableListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\SolrIndexingProcessListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\SolrIndexingProcessListener
     */
    protected function getSolrIndexingProcessListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\SolrIndexingProcessListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\SolrIndexingProcessListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\StaticCacheableListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\StaticCacheableListener
     */
    protected function getStaticCacheableListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\StaticCacheableListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\StaticCacheableListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\ValidRequestMethodListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\ValidRequestMethodListener
     */
    protected function getValidRequestMethodListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\ValidRequestMethodListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\ValidRequestMethodListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Listener\ValidUriListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Listener\ValidUriListener
     */
    protected function getValidUriListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\Cache\\Listener\\ValidUriListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Listener\ValidUriListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\Enable' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\Enable
     */
    protected function getEnableService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\Enable'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\Enable::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\Enable'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\LoginDeniedConfiguration' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\LoginDeniedConfiguration
     */
    protected function getLoginDeniedConfigurationService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\LoginDeniedConfiguration'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\LoginDeniedConfiguration::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\LoginDeniedConfiguration'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\NoFakeFrontend' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\NoFakeFrontend
     */
    protected function getNoFakeFrontendService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\NoFakeFrontend'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\NoFakeFrontend::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\NoFakeFrontend'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\NoIntScripts' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\NoIntScripts
     */
    protected function getNoIntScriptsService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\NoIntScripts'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\NoIntScripts::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\NoIntScripts'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\NoLongPathSegment' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\NoLongPathSegment
     */
    protected function getNoLongPathSegmentService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\NoLongPathSegment'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\NoLongPathSegment::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\NoLongPathSegment'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\NoNoCache' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\NoNoCache
     */
    protected function getNoNoCacheService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\NoNoCache'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\NoNoCache::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\NoNoCache'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\NoUserOrGroupSet' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\NoUserOrGroupSet
     */
    protected function getNoUserOrGroupSetService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\NoUserOrGroupSet'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\NoUserOrGroupSet::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\NoUserOrGroupSet'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\NoWorkspacePreview' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\NoWorkspacePreview
     */
    protected function getNoWorkspacePreviewService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\NoWorkspacePreview'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\NoWorkspacePreview::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\NoWorkspacePreview'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\SiteCacheable' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\SiteCacheable
     */
    protected function getSiteCacheableService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\SiteCacheable'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\SiteCacheable::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\SiteCacheable'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\ValidDoktype' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\ValidDoktype
     */
    protected function getValidDoktypeService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\ValidDoktype'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\ValidDoktype::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\ValidDoktype'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Cache\Rule\ValidPageInformation' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Cache\Rule\ValidPageInformation
     */
    protected function getValidPageInformationService()
    {
        $this->services['SFC\\Staticfilecache\\Cache\\Rule\\ValidPageInformation'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Cache\Rule\ValidPageInformation::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Cache\\Rule\\ValidPageInformation'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Command\BoostQueueCommand' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Command\BoostQueueCommand
     */
    protected function getBoostQueueCommandService()
    {
        $this->services['SFC\\Staticfilecache\\Command\\BoostQueueCommand'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Command\BoostQueueCommand::class, ($this->services['SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository'] ?? $this->getQueueRepositoryService()), ($this->services['SFC\\Staticfilecache\\Service\\QueueService'] ?? $this->getQueueServiceService()));

        $instance->setName('staticfilecache:boostQueue');
        $instance->setDescription('Run (work on) the cache boost queue. Call this task every 5 minutes.');

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Configuration' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Configuration
     */
    protected function getConfigurationService()
    {
        $this->services['SFC\\Staticfilecache\\Configuration'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Configuration::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Configuration'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Controller\BackendController' autowired service.
     *
     * @return \SFC\Staticfilecache\Controller\BackendController
     */
    protected function getBackendControllerService()
    {
        $this->factories['SFC\\Staticfilecache\\Controller\\BackendController'] = function () {
            $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Controller\BackendController::class, ($this->services['SFC\\Staticfilecache\\Service\\QueueService'] ?? $this->getQueueServiceService()));
        ...
        return $this->factories['SFC\\Staticfilecache\\Controller\\BackendController']();
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Domain\Repository\CacheRepository' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Domain\Repository\CacheRepository
     */
    protected function getCacheRepositoryService()
    {
        $this->services['SFC\\Staticfilecache\\Domain\\Repository\\CacheRepository'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Domain\Repository\CacheRepository::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Domain\\Repository\\CacheRepository'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Domain\Repository\PageRepository' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Domain\Repository\PageRepository
     */
    protected function getPageRepositoryService()
    {
        $this->services['SFC\\Staticfilecache\\Domain\\Repository\\PageRepository'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Domain\Repository\PageRepository::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Domain\\Repository\\PageRepository'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Domain\Repository\QueueRepository' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Domain\Repository\QueueRepository
     */
    protected function getQueueRepositoryService()
    {
        $this->services['SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Domain\Repository\QueueRepository::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\EventListener\AfterPackageDeactivationListener' shared autowired service.
     *
     * @return \SFC\Staticfilecache\EventListener\AfterPackageDeactivationListener
     */
    protected function getAfterPackageDeactivationListenerService()
    {
        return $this->services['SFC\\Staticfilecache\\EventListener\\AfterPackageDeactivationListener'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\EventListener\AfterPackageDeactivationListener::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Generator\BrotliGenerator' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Generator\BrotliGenerator
     */
    protected function getBrotliGeneratorService()
    {
        $this->services['SFC\\Staticfilecache\\Generator\\BrotliGenerator'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Generator\BrotliGenerator::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Generator\\BrotliGenerator'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Generator\ConfigGenerator' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Generator\ConfigGenerator
     */
    protected function getConfigGeneratorService()
    {
        $this->services['SFC\\Staticfilecache\\Generator\\ConfigGenerator'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Generator\ConfigGenerator::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Generator\\ConfigGenerator'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Generator\GzipGenerator' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Generator\GzipGenerator
     */
    protected function getGzipGeneratorService()
    {
        $this->services['SFC\\Staticfilecache\\Generator\\GzipGenerator'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Generator\GzipGenerator::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Generator\\GzipGenerator'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Generator\HtaccessGenerator' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Generator\HtaccessGenerator
     */
    protected function getHtaccessGeneratorService()
    {
        $this->services['SFC\\Staticfilecache\\Generator\\HtaccessGenerator'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Generator\HtaccessGenerator::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Generator\\HtaccessGenerator'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Generator\ManifestGenerator' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Generator\ManifestGenerator
     */
    protected function getManifestGeneratorService()
    {
        $this->services['SFC\\Staticfilecache\\Generator\\ManifestGenerator'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Generator\ManifestGenerator::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Generator\\ManifestGenerator'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Generator\PlainGenerator' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Generator\PlainGenerator
     */
    protected function getPlainGeneratorService()
    {
        $this->services['SFC\\Staticfilecache\\Generator\\PlainGenerator'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Generator\PlainGenerator::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Generator\\PlainGenerator'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Hook\AbstractHook' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Hook\AbstractHook
     */
    protected function getAbstractHookService()
    {
        $this->services['SFC\\Staticfilecache\\Hook\\AbstractHook'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Hook\AbstractHook::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Hook\\AbstractHook'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Hook\DatamapHook' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Hook\DatamapHook
     */
    protected function getDatamapHookService()
    {
        $this->services['SFC\\Staticfilecache\\Hook\\DatamapHook'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Hook\DatamapHook::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Hook\\DatamapHook'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Hook\LogoffFrontendUser' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Hook\LogoffFrontendUser
     */
    protected function getLogoffFrontendUserService()
    {
        $this->services['SFC\\Staticfilecache\\Hook\\LogoffFrontendUser'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Hook\LogoffFrontendUser::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Hook\\LogoffFrontendUser'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Middleware\FallbackMiddleware' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Middleware\FallbackMiddleware
     */
    protected function getFallbackMiddlewareService()
    {
        return $this->services['SFC\\Staticfilecache\\Middleware\\FallbackMiddleware'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Middleware\FallbackMiddleware::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()), ($this->services['SFC\\Staticfilecache\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()));
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Middleware\FrontendUserMiddleware' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Middleware\FrontendUserMiddleware
     */
    protected function getFrontendUserMiddlewareService()
    {
        return $this->services['SFC\\Staticfilecache\\Middleware\\FrontendUserMiddleware'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Middleware\FrontendUserMiddleware::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Middleware\GenerateMiddleware' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Middleware\GenerateMiddleware
     */
    protected function getGenerateMiddlewareService()
    {
        return $this->services['SFC\\Staticfilecache\\Middleware\\GenerateMiddleware'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Middleware\GenerateMiddleware::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Middleware\ManifestMiddleware' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Middleware\ManifestMiddleware
     */
    protected function getManifestMiddlewareService()
    {
        return $this->services['SFC\\Staticfilecache\\Middleware\\ManifestMiddleware'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Middleware\ManifestMiddleware::class);
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Middleware\PrepareMiddleware' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Middleware\PrepareMiddleware
     */
    protected function getPrepareMiddlewareService()
    {
        return $this->services['SFC\\Staticfilecache\\Middleware\\PrepareMiddleware'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Middleware\PrepareMiddleware::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\AbstractService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\AbstractService
     */
    protected function getAbstractServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\AbstractService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\AbstractService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\AbstractService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\CacheService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\CacheService
     */
    protected function getCacheServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\CacheService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\CacheService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\CacheService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\ClientService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\ClientService
     */
    protected function getClientServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\ClientService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\ClientService::class, ($this->services['Psr\\EventDispatcher\\EventDispatcherInterface_decorated_1'] ?? $this->getEventDispatcherInterfaceDecorated1Service()));

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\ClientService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\ConfigurationService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\ConfigurationService
     */
    protected function getConfigurationServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\ConfigurationService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\ConfigurationService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\ConfigurationService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\CookieService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\CookieService
     */
    protected function getCookieServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\CookieService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\CookieService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\CookieService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\DateTimeService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\DateTimeService
     */
    protected function getDateTimeServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\DateTimeService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\DateTimeService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\DateTimeService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\GeneratorService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\GeneratorService
     */
    protected function getGeneratorServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\GeneratorService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\GeneratorService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\GeneratorService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\HtaccessConfigurationService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\HtaccessConfigurationService
     */
    protected function getHtaccessConfigurationServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\HtaccessConfigurationService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\HtaccessConfigurationService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\HtaccessConfigurationService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\HttpPushService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\HttpPushService
     */
    protected function getHttpPushServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\HttpPushService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\HttpPushService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\HttpPushService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\HttpPush\FontHttpPush' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\HttpPush\FontHttpPush
     */
    protected function getFontHttpPushService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\HttpPush\\FontHttpPush'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\HttpPush\FontHttpPush::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\HttpPush\\FontHttpPush'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\HttpPush\ImageHttpPush' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\HttpPush\ImageHttpPush
     */
    protected function getImageHttpPushService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\HttpPush\\ImageHttpPush'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\HttpPush\ImageHttpPush::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\HttpPush\\ImageHttpPush'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\HttpPush\ScriptHttpPush' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\HttpPush\ScriptHttpPush
     */
    protected function getScriptHttpPushService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\HttpPush\\ScriptHttpPush'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\HttpPush\ScriptHttpPush::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\HttpPush\\ScriptHttpPush'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\HttpPush\StyleHttpPush' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\HttpPush\StyleHttpPush
     */
    protected function getStyleHttpPushService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\HttpPush\\StyleHttpPush'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\HttpPush\StyleHttpPush::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\HttpPush\\StyleHttpPush'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\ObjectFactoryService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\ObjectFactoryService
     */
    protected function getObjectFactoryServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\ObjectFactoryService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\ObjectFactoryService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\ObjectFactoryService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\QueueService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\QueueService
     */
    protected function getQueueServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\QueueService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\QueueService::class, ($this->services['SFC\\Staticfilecache\\Domain\\Repository\\QueueRepository'] ?? $this->getQueueRepositoryService()), ($this->services['SFC\\Staticfilecache\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()), ($this->services['SFC\\Staticfilecache\\Service\\ClientService'] ?? $this->getClientServiceService()), ($this->services['SFC\\Staticfilecache\\Service\\CacheService'] ?? $this->getCacheServiceService()));

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\QueueService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\RemoveService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\RemoveService
     */
    protected function getRemoveServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\RemoveService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\RemoveService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\RemoveService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\Service\TypoScriptFrontendService' shared autowired service.
     *
     * @return \SFC\Staticfilecache\Service\TypoScriptFrontendService
     */
    protected function getTypoScriptFrontendServiceService()
    {
        $this->services['SFC\\Staticfilecache\\Service\\TypoScriptFrontendService'] = $instance = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\Service\TypoScriptFrontendService::class);

        $instance->setLogger(($this->services['_early.TYPO3\\CMS\\Core\\Log\\LogManager'] ?? $this->get('_early.TYPO3\\CMS\\Core\\Log\\LogManager', 1))->getLogger('SFC\\Staticfilecache\\Service\\TypoScriptFrontendService'));

        return $instance;
    }

    /**
     * Gets the public 'SFC\Staticfilecache\ViewHelpers\Be\Menus\ActionMenuViewHelper' autowired service.
     *
     * @return \SFC\Staticfilecache\ViewHelpers\Be\Menus\ActionMenuViewHelper
     */
    protected function getActionMenuViewHelperService()
    {
        $this->factories['SFC\\Staticfilecache\\ViewHelpers\\Be\\Menus\\ActionMenuViewHelper'] = function () {
            return \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\SFC\Staticfilecache\ViewHelpers\Be\Menus\ActionMenuViewHelper::class);
        };

        return $this->factories['SFC\\Staticfilecache\\ViewHelpers\\Be\\Menus\\ActionMenuViewHelper']();
    }
     ...
     */
    protected function getBackendController2Service()
    {
    ...
    protected function getCommandRegistryDecorated2Service()
    {
        ...
        $a->addLazyCommand('container:fixLanguageModeCommand', 'B13\\Container\\Command\\FixLanguageModeCommand', 'connect children of connected container if possible, else disconnect container', false, false, NULL);
        $a->addLazyCommand('container:fixContainerParentForConnectedModeCommand', 'B13\\Container\\Command\\FixContainerParentForConnectedModeCommand', 'tx_container_parent of children in connected mode should point to default language container', false, false, NULL);
        ...
        $a->addLazyCommand('staticfilecache:boostQueue', 'SFC\\Staticfilecache\\Command\\BoostQueueCommand', 'Run (work on) the cache boost queue. Call this task every 5 minutes.', false, true, NULL);
    ...
    protected function getListenerProviderDecorated3Service()
    {
        ...
        $a->addListener('TYPO3\\CMS\\Core\\Package\\Event\\AfterPackageDeactivationEvent', 'SFC\\Staticfilecache\\EventListener\\AfterPackageDeactivationListener', NULL);
        ...
        $a->addListener('TYPO3\\CMS\\Core\\Configuration\\Event\\ModifyLoadedPageTsConfigEvent', 'B13\\Container\\Listener\\PageTsConfig', NULL);
        $a->addListener('TYPO3\\CMS\\Core\\Core\\Event\\BootCompletedEvent', 'B13\\Container\\Listener\\BootCompleted', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\PageCacheableListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\ValidRequestMethodListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\ValidUriListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\ForceStaticCacheListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\NoBackendUserListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\StaticCacheableListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleFallbackEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\NoBackendUserCookieListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleFallbackEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\ValidRequestMethodListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleFallbackEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\ValidUriListener', NULL);
        $a->addListener('SFC\\Staticfilecache\\Event\\CacheRuleFallbackEvent', 'SFC\\Staticfilecache\\Cache\\Listener\\SolrIndexingProcessListener', NULL);
     ...
     */
    protected function getCacheService2Service()
    {
     ...
     */
    protected function getActionMenuViewHelper2Service()
    {
     ...
     */
    protected function getConfigurationService3Service()
    {
    ...
    /**
     * Gets the public 'icons_decorated_40' shared service.
     *
     * @return \ArrayObject
     */
    protected function getIconsDecorated40Service()
    {
        $a = ($this->services['service_provider_registry'] ?? $this->get('service_provider_registry', 1));

        return $this->services['icons_decorated_40'] = $a->extendService('ws_scss', 'icons', $this, $a->extendService('staticfilecache', 'icons', $this, $a->extendService('provider', 'icons', $this, $a->extendService('forum', 'icons', $this, $a->extendService('faicon', 'icons', $this, $a->extendService('container_elements', 'icons', $this, $a->extendService('pvh', 'icons', $this, $a->extendService('container', 'icons', $this, $a->extendService('viewpage', 'icons', $this, $a->extendService('tstemplate', 'icons', $this, $a->extendService('t3editor', 'icons', $this, $a->extendService('sys_note', 'icons', $this, $a->extendService('seo', 'icons', $this, \TYPO3\CMS\Lowlevel\ServiceProvider::configureIcons($this, $a->extendService('info', 'icons', $this, $a->extendService('filemetadata', 'icons', $this, $a->extendService('felogin', 'icons', $this, $a->extendService('extensionmanager', 'icons', $this, \TYPO3\CMS\Dashboard\ServiceProvider::configureIcons($this, $a->extendService('beuser', 'icons', $this, $a->extendService('belog', 'icons', $this, $a->extendService('adminpanel', 'icons', $this, $a->extendService('rte_ckeditor', 'icons', $this, $a->extendService('setup', 'icons', $this, $a->extendService('recycler', 'icons', $this, $a->extendService('indexed_search', 'icons', $this, \TYPO3\CMS\Backend\ServiceProvider::configureIcons($this, $a->extendService('recordlist', 'icons', $this, $a->extendService('redirects', 'icons', $this, $a->extendService('reports', 'icons', $this, \TYPO3\CMS\Install\ServiceProvider::configureIcons($this, $a->extendService('form', 'icons', $this, $a->extendService('impexp', 'icons', $this, $a->extendService('filelist', 'icons', $this, $a->extendService('fluid_styled_content', 'icons', $this, \TYPO3\CMS\Frontend\ServiceProvider::configureIcons($this, \TYPO3\CMS\Fluid\ServiceProvider::configureIcons($this, \TYPO3\CMS\Extbase\ServiceProvider::configureIcons($this, $a->extendService('scheduler', 'icons', $this, \TYPO3\CMS\Core\ServiceProvider::configureIcons($this, \TYPO3\CMS\Core\ServiceProvider::getIcons($this)))))))))))))))))))))))))))))))))))))))));
    }

    /**
     * Gets the public 'middlewares_decorated_39' shared service.
     *
     * @return \ArrayObject
     */
    protected function getMiddlewaresDecorated39Service()
    {
        $a = ($this->services['service_provider_registry'] ?? $this->get('service_provider_registry', 1));

        return $this->services['middlewares_decorated_39'] = $a->extendService('ws_scss', 'middlewares', $this, $a->extendService('staticfilecache', 'middlewares', $this, $a->extendService('provider', 'middlewares', $this, $a->extendService('forum', 'middlewares', $this, $a->extendService('faicon', 'middlewares', $this, $a->extendService('container_elements', 'middlewares', $this, $a->extendService('pvh', 'middlewares', $this, $a->extendService('container', 'middlewares', $this, $a->extendService('viewpage', 'middlewares', $this, $a->extendService('tstemplate', 'middlewares', $this, $a->extendService('t3editor', 'middlewares', $this, $a->extendService('sys_note', 'middlewares', $this, $a->extendService('seo', 'middlewares', $this, \TYPO3\CMS\Lowlevel\ServiceProvider::configureMiddlewares($this, $a->extendService('info', 'middlewares', $this, $a->extendService('filemetadata', 'middlewares', $this, $a->extendService('felogin', 'middlewares', $this, $a->extendService('extensionmanager', 'middlewares', $this, \TYPO3\CMS\Dashboard\ServiceProvider::configureMiddlewares($this, $a->extendService('beuser', 'middlewares', $this, $a->extendService('belog', 'middlewares', $this, $a->extendService('adminpanel', 'middlewares', $this, $a->extendService('rte_ckeditor', 'middlewares', $this, $a->extendService('setup', 'middlewares', $this, $a->extendService('recycler', 'middlewares', $this, $a->extendService('indexed_search', 'middlewares', $this, \TYPO3\CMS\Backend\ServiceProvider::configureMiddlewares($this, $a->extendService('recordlist', 'middlewares', $this, $a->extendService('redirects', 'middlewares', $this, $a->extendService('reports', 'middlewares', $this, $a->extendService('form', 'middlewares', $this, $a->extendService('impexp', 'middlewares', $this, $a->extendService('filelist', 'middlewares', $this, $a->extendService('fluid_styled_content', 'middlewares', $this, \TYPO3\CMS\Frontend\ServiceProvider::configureMiddlewares($this, \TYPO3\CMS\Fluid\ServiceProvider::configureMiddlewares($this, \TYPO3\CMS\Extbase\ServiceProvider::configureMiddlewares($this, $a->extendService('scheduler', 'middlewares', $this, \TYPO3\CMS\Core\ServiceProvider::configureMiddlewares($this, \TYPO3\CMS\Core\ServiceProvider::getMiddlewares($this))))))))))))))))))))))))))))))))))))))));
    }
     ...
     */
    protected function getPageRepository2Service()
    {
